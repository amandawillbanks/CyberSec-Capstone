...
const styles = {
  ...
  modal: {
    ...
    borderTop: `3px solid ${CK.cyan}`,
    boxShadow: `0 0 60px rgba(0,255,247,0.15), 0 0 120px rgba(0,255,247,0.05)`,
    display: "flex",
  ...
  sidebar: {
    width: 215,
    flexShrink: 0,
    borderRight: `1px solid rgba(0,255,247,0.12)`,
    overflowY: "auto",
    padding: "8px 0",
    display: "flex",
    flexDirection: "column",
  ...
  sideItemActive: {
    ...
    color: CK.cyan,
    borderLeft: `2px solid ${CK.cyan}`,
    paddingLeft: 12,
    textShadow: `0 0 8px rgba(0,255,247,0.4)`,
  },
  sideNum: { fontSize: 10, fontWeight: 700, color: "rgba(0,255,247,0.35)", minWidth: 16 },
  sideText: { display: "flex", flexDirection: "column", gap: 2 },
  sideName: { fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em" },
  sideDomain: { fontSize: 10, letterSpacing: "0.05em" },
  ...
  contentTitle: {
    ...
    textShadow: `0 0 14px rgba(0,255,247,0.4)`,
  },
  domainBadge: {
    padding: "3px 10px",
    border: "1px solid",
  ...
  stageCard: {
    ...
    borderTop: `2px solid rgba(0,255,247,0.3)`,
    padding: "12px 14px",
  },
  stageHeader: {
    display: "flex",
  ...
  stageLabel: {
    ...
    textTransform: "uppercase",
    letterSpacing: "0.08em",
    textShadow: `0 0 8px rgba(0,255,247,0.3)`,
  },
  stageTimer: {
    fontSize: 10,
  ...
  mitCard: {
    ...
    border: `1px solid rgba(0,255,247,0.12)`,
    borderLeft: `2px solid rgba(0,255,247,0.4)`,
    padding: "12px 14px",
  },
  mitLabel: {
    fontSize: 12,
